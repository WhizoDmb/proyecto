...
<div class="container mt-5">
    ...
    <form action="{{ route('membresias.store') }}" method="POST" style="padding:30px">
        @csrf
        <div class="mb-3">
            <label for="inputNombre" class="form-label">Nombre</label>
            <input type="text" name="nombre" class="form-control form-control-custom" id="inputNombre" placeholder="Introduce el nombre de la membresia">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="costo" class="form-control form-control-custom" id="inputCostoAdicional" placeholder="0.00">
